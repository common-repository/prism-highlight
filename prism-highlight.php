...
Plugin URI: http://bloggyaani.com/speed-up-wordpress/
...
function wpsites_add_prism_css_js() {
	if ( ! is_admin() ) {
			...
			wp_enqueue_script( 'prismjs', plugins_url( 'js/prism-highlight.js', __FILE__ ), '', '1.6', true );
			wp_enqueue_style( 'prismcss', plugins_url( 'css/prism-highlight.css', __FILE__ ), '', '1.6', true );
